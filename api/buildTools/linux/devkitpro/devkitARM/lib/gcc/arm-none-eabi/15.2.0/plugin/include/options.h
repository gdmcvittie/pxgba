...
#endif
#ifdef GENERATOR_FILE
extern int dlstp_enabled;
#else
  int x_dlstp_enabled;
#define dlstp_enabled global_options.x_dlstp_enabled
#endif
#ifdef GENERATOR_FILE
...
enum opt_code
{
  ...
  OPT_list = 2038,                           /* -list */
  OPT_mabi_ = 2039,                          /* -mabi= */
  OPT_mabort_on_noreturn = 2040,             /* -mabort-on-noreturn */
  OPT_main = 2041,                           /* -main */
  OPT_main_ = 2042,                          /* -main= */
  OPT_mapcs = 2043,                          /* -mapcs */
  OPT_mapcs_frame = 2044,                    /* -mapcs-frame */
  OPT_mapcs_reentrant = 2045,                /* -mapcs-reentrant */
  OPT_mapcs_stack_check = 2046,              /* -mapcs-stack-check */
  OPT_march_ = 2047,                         /* -march= */
  OPT_marm = 2048,                           /* -marm */
  OPT_masm_syntax_unified = 2049,            /* -masm-syntax-unified */
  OPT_mbe32 = 2050,                          /* -mbe32 */
  OPT_mbe8 = 2051,                           /* -mbe8 */
  OPT_mbig_endian = 2052,                    /* -mbig-endian */
  OPT_mbranch_cost_ = 2053,                  /* -mbranch-cost= */
  OPT_mbranch_protection_ = 2054,            /* -mbranch-protection= */
  OPT_mcallee_super_interworking = 2055,     /* -mcallee-super-interworking */
  OPT_mcaller_super_interworking = 2056,     /* -mcaller-super-interworking */
  OPT_mcmse = 2057,                          /* -mcmse */
  OPT_mcpu_ = 2058,                          /* -mcpu= */
  OPT_mdlstp = 2059,                         /* -mdlstp */
  OPT_mfdpic = 2060,                         /* -mfdpic */
  OPT_mfix_cmse_cve_2021_35465 = 2061,       /* -mfix-cmse-cve-2021-35465 */
  OPT_mfix_cortex_a57_aes_1742098 = 2062,    /* -mfix-cortex-a57-aes-1742098 */
  /* OPT_mfix_cortex_a72_aes_1655431 = 2063, *//* -mfix-cortex-a72-aes-1655431 */
  OPT_mfix_cortex_m3_ldrd = 2064,            /* -mfix-cortex-m3-ldrd */
  OPT_mflip_thumb = 2065,                    /* -mflip-thumb */
  OPT_mfloat_abi_ = 2066,                    /* -mfloat-abi= */
  OPT_mfp16_format_ = 2067,                  /* -mfp16-format= */
  OPT_mfpu_ = 2068,                          /* -mfpu= */
  OPT_mgeneral_regs_only = 2069,             /* -mgeneral-regs-only */
  /* OPT_mhard_float = 2070, */              /* -mhard-float */
  OPT_mlibarch_ = 2071,                      /* -mlibarch= */
  OPT_mlittle_endian = 2072,                 /* -mlittle-endian */
  OPT_mlong_calls = 2073,                    /* -mlong-calls */
  OPT_mneon_for_64bits = 2074,               /* -mneon-for-64bits */
  OPT_mpic_data_is_text_relative = 2075,     /* -mpic-data-is-text-relative */
  OPT_mpic_register_ = 2076,                 /* -mpic-register= */
  OPT_mpoke_function_name = 2077,            /* -mpoke-function-name */
  OPT_mprint_tune_info = 2078,               /* -mprint-tune-info */
  OPT_mpure_code = 2079,                     /* -mpure-code */
  OPT_mrestrict_it = 2080,                   /* -mrestrict-it */
  OPT_msched_prolog = 2081,                  /* -msched-prolog */
  OPT_msingle_pic_base = 2082,               /* -msingle-pic-base */
  OPT_mslow_flash_data = 2083,               /* -mslow-flash-data */
  /* OPT_msoft_float = 2084, */              /* -msoft-float */
  OPT_mstack_protector_guard_offset_ = 2085, /* -mstack-protector-guard-offset= */
  OPT_mstack_protector_guard_ = 2086,        /* -mstack-protector-guard= */
  OPT_mstructure_size_boundary_ = 2087,      /* -mstructure-size-boundary= */
  OPT_mthumb = 2088,                         /* -mthumb */
  OPT_mthumb_interwork = 2089,               /* -mthumb-interwork */
  OPT_mtls_dialect_ = 2090,                  /* -mtls-dialect= */
  OPT_mtp_ = 2091,                           /* -mtp= */
  OPT_mtpcs_frame = 2092,                    /* -mtpcs-frame */
  OPT_mtpcs_leaf_frame = 2093,               /* -mtpcs-leaf-frame */
  OPT_mtune_ = 2094,                         /* -mtune= */
  OPT_munaligned_access = 2095,              /* -munaligned-access */
  OPT_mvectorize_with_neon_double = 2096,    /* -mvectorize-with-neon-double */
  OPT_mvectorize_with_neon_quad = 2097,      /* -mvectorize-with-neon-quad */
  OPT_mverbose_cost_dump = 2098,             /* -mverbose-cost-dump */
  OPT_mword_relocations = 2099,              /* -mword-relocations */
  OPT_n = 2100,                              /* -n */
  OPT_name_sort = 2101,                      /* -name-sort */
  OPT_no_canonical_prefixes = 2102,          /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 2103,              /* -no-integrated-cpp */
  OPT_no_pie = 2104,                         /* -no-pie */
  OPT_nocpp = 2105,                          /* -nocpp */
  OPT_nodefaultlibs = 2106,                  /* -nodefaultlibs */
  OPT_nolibc = 2107,                         /* -nolibc */
  OPT_nomain = 2108,                         /* -nomain */
  OPT_nophoboslib = 2109,                    /* -nophoboslib */
  OPT_nostartfiles = 2110,                   /* -nostartfiles */
  OPT_nostdinc = 2111,                       /* -nostdinc */
  OPT_nostdinc__ = 2112,                     /* -nostdinc++ */
  OPT_nostdlib = 2113,                       /* -nostdlib */
  OPT_nostdlib__ = 2114,                     /* -nostdlib++ */
  OPT_o = 2115,                              /* -o */
  OPT_objects = 2116,                        /* -objects */
  OPT_p = 2117,                              /* -p */
  OPT_pass_exit_codes = 2118,                /* -pass-exit-codes */
  /* OPT_pedantic = 2119, */                 /* -pedantic */
  OPT_pedantic_errors = 2120,                /* -pedantic-errors */
  OPT_pg = 2121,                             /* -pg */
  OPT_pie = 2122,                            /* -pie */
  OPT_pipe = 2123,                           /* -pipe */
  OPT_preprocess = 2124,                     /* -preprocess */
  OPT_print_file_name_ = 2125,               /* -print-file-name= */
  OPT_print_libgcc_file_name = 2126,         /* -print-libgcc-file-name */
  OPT_print_multi_directory = 2127,          /* -print-multi-directory */
  OPT_print_multi_lib = 2128,                /* -print-multi-lib */
  OPT_print_multi_os_directory = 2129,       /* -print-multi-os-directory */
  OPT_print_multiarch = 2130,                /* -print-multiarch */
  OPT_print_objc_runtime_info = 2131,        /* -print-objc-runtime-info */
  OPT_print_prog_name_ = 2132,               /* -print-prog-name= */
  OPT_print_search_dirs = 2133,              /* -print-search-dirs */
  OPT_print_sysroot = 2134,                  /* -print-sysroot */
  OPT_print_sysroot_headers_suffix = 2135,   /* -print-sysroot-headers-suffix */
  OPT_print_value = 2136,                    /* -print-value */
  OPT_pthread = 2137,                        /* -pthread */
  OPT_quiet = 2138,                          /* -quiet */
  OPT_r = 2139,                              /* -r */
  OPT_remap = 2140,                          /* -remap */
  OPT_reverse_sort = 2141,                   /* -reverse-sort */
  OPT_s = 2142,                              /* -s */
  OPT_save_temps = 2143,                     /* -save-temps */
  OPT_save_temps_ = 2144,                    /* -save-temps= */
  OPT_shared = 2145,                         /* -shared */
  OPT_shared_libgcc = 2146,                  /* -shared-libgcc */
  OPT_shared_libphobos = 2147,               /* -shared-libphobos */
  OPT_size_sort = 2148,                      /* -size-sort */
  /* OPT_specs = 2149, */                    /* -specs */
  OPT_specs_ = 2150,                         /* -specs= */
  OPT_static = 2151,                         /* -static */
  OPT_static_libasan = 2152,                 /* -static-libasan */
  OPT_static_libgcc = 2153,                  /* -static-libgcc */
  OPT_static_libgcobol = 2154,               /* -static-libgcobol */
  OPT_static_libgfortran = 2155,             /* -static-libgfortran */
  OPT_static_libgm2 = 2156,                  /* -static-libgm2 */
  OPT_static_libgo = 2157,                   /* -static-libgo */
  OPT_static_libhwasan = 2158,               /* -static-libhwasan */
  OPT_static_liblsan = 2159,                 /* -static-liblsan */
  OPT_static_libmpx = 2160,                  /* -static-libmpx */
  OPT_static_libmpxwrappers = 2161,          /* -static-libmpxwrappers */
  OPT_static_libphobos = 2162,               /* -static-libphobos */
  OPT_static_libquadmath = 2163,             /* -static-libquadmath */
  OPT_static_libstdc__ = 2164,               /* -static-libstdc++ */
  OPT_static_libtsan = 2165,                 /* -static-libtsan */
  OPT_static_libubsan = 2166,                /* -static-libubsan */
  OPT_static_pie = 2167,                     /* -static-pie */
  /* OPT_std_c__03 = 2168, */                /* -std=c++03 */
  /* OPT_std_c__0x = 2169, */                /* -std=c++0x */
  OPT_std_c__11 = 2170,                      /* -std=c++11 */
  OPT_std_c__14 = 2171,                      /* -std=c++14 */
  OPT_std_c__17 = 2172,                      /* -std=c++17 */
  /* OPT_std_c__1y = 2173, */                /* -std=c++1y */
  /* OPT_std_c__1z = 2174, */                /* -std=c++1z */
  OPT_std_c__20 = 2175,                      /* -std=c++20 */
  OPT_std_c__23 = 2176,                      /* -std=c++23 */
  OPT_std_c__26 = 2177,                      /* -std=c++26 */
  /* OPT_std_c__2a = 2178, */                /* -std=c++2a */
  /* OPT_std_c__2b = 2179, */                /* -std=c++2b */
  /* OPT_std_c__2c = 2180, */                /* -std=c++2c */
  OPT_std_c__98 = 2181,                      /* -std=c++98 */
  OPT_std_c11 = 2182,                        /* -std=c11 */
  OPT_std_c17 = 2183,                        /* -std=c17 */
  /* OPT_std_c18 = 2184, */                  /* -std=c18 */
  /* OPT_std_c1x = 2185, */                  /* -std=c1x */
  OPT_std_c23 = 2186,                        /* -std=c23 */
  /* OPT_std_c2x = 2187, */                  /* -std=c2x */
  OPT_std_c2y = 2188,                        /* -std=c2y */
  /* OPT_std_c89 = 2189, */                  /* -std=c89 */
  OPT_std_c90 = 2190,                        /* -std=c90 */
  OPT_std_c99 = 2191,                        /* -std=c99 */
  /* OPT_std_c9x = 2192, */                  /* -std=c9x */
  OPT_std_f2003 = 2193,                      /* -std=f2003 */
  OPT_std_f2008 = 2194,                      /* -std=f2008 */
  OPT_std_f2008ts = 2195,                    /* -std=f2008ts */
  OPT_std_f2018 = 2196,                      /* -std=f2018 */
  OPT_std_f2023 = 2197,                      /* -std=f2023 */
  OPT_std_f202y = 2198,                      /* -std=f202y */
  OPT_std_f95 = 2199,                        /* -std=f95 */
  OPT_std_gnu = 2200,                        /* -std=gnu */
  /* OPT_std_gnu__03 = 2201, */              /* -std=gnu++03 */
  /* OPT_std_gnu__0x = 2202, */              /* -std=gnu++0x */
  OPT_std_gnu__11 = 2203,                    /* -std=gnu++11 */
  OPT_std_gnu__14 = 2204,                    /* -std=gnu++14 */
  OPT_std_gnu__17 = 2205,                    /* -std=gnu++17 */
  /* OPT_std_gnu__1y = 2206, */              /* -std=gnu++1y */
  /* OPT_std_gnu__1z = 2207, */              /* -std=gnu++1z */
  OPT_std_gnu__20 = 2208,                    /* -std=gnu++20 */
  OPT_std_gnu__23 = 2209,                    /* -std=gnu++23 */
  OPT_std_gnu__26 = 2210,                    /* -std=gnu++26 */
  /* OPT_std_gnu__2a = 2211, */              /* -std=gnu++2a */
  /* OPT_std_gnu__2b = 2212, */              /* -std=gnu++2b */
  /* OPT_std_gnu__2c = 2213, */              /* -std=gnu++2c */
  OPT_std_gnu__98 = 2214,                    /* -std=gnu++98 */
  OPT_std_gnu11 = 2215,                      /* -std=gnu11 */
  OPT_std_gnu17 = 2216,                      /* -std=gnu17 */
  /* OPT_std_gnu18 = 2217, */                /* -std=gnu18 */
  /* OPT_std_gnu1x = 2218, */                /* -std=gnu1x */
  OPT_std_gnu23 = 2219,                      /* -std=gnu23 */
  /* OPT_std_gnu2x = 2220, */                /* -std=gnu2x */
  OPT_std_gnu2y = 2221,                      /* -std=gnu2y */
  /* OPT_std_gnu89 = 2222, */                /* -std=gnu89 */
  OPT_std_gnu90 = 2223,                      /* -std=gnu90 */
  OPT_std_gnu99 = 2224,                      /* -std=gnu99 */
  /* OPT_std_gnu9x = 2225, */                /* -std=gnu9x */
  /* OPT_std_iso9899_1990 = 2226, */         /* -std=iso9899:1990 */
  OPT_std_iso9899_199409 = 2227,             /* -std=iso9899:199409 */
  /* OPT_std_iso9899_1999 = 2228, */         /* -std=iso9899:1999 */
  /* OPT_std_iso9899_199x = 2229, */         /* -std=iso9899:199x */
  /* OPT_std_iso9899_2011 = 2230, */         /* -std=iso9899:2011 */
  /* OPT_std_iso9899_2017 = 2231, */         /* -std=iso9899:2017 */
  /* OPT_std_iso9899_2018 = 2232, */         /* -std=iso9899:2018 */
  /* OPT_std_iso9899_2024 = 2233, */         /* -std=iso9899:2024 */
  OPT_std_legacy = 2234,                     /* -std=legacy */
  OPT_stdlib_ = 2235,                        /* -stdlib= */
  OPT_symbol_ = 2236,                        /* -symbol= */
  OPT_symbolic = 2237,                       /* -symbolic */
  OPT_t = 2238,                              /* -t */
  OPT_time = 2239,                           /* -time */
  OPT_time_ = 2240,                          /* -time= */
  OPT_traditional = 2241,                    /* -traditional */
  OPT_traditional_cpp = 2242,                /* -traditional-cpp */
  OPT_tree_stats = 2243,                     /* -tree-stats */
  OPT_trigraphs = 2244,                      /* -trigraphs */
  OPT_truncate = 2245,                       /* -truncate */
  OPT_type_stats = 2246,                     /* -type-stats */
  OPT_u = 2247,                              /* -u */
  OPT_undef = 2248,                          /* -undef */
  OPT_v = 2249,                              /* -v */
  OPT_version = 2250,                        /* -version */
  OPT_w = 2251,                              /* -w */
  OPT_wrapper = 2252,                        /* -wrapper */
  OPT_x = 2253,                              /* -x */
  OPT_z = 2254,                              /* -z */
  N_OPTS,
  OPT_SPECIAL_unknown,
