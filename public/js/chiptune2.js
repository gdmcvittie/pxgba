...
ChiptuneJsPlayer.prototype.load = function(input, callback) {
  ...
  if (input instanceof File) {
    ...
    xhr.onprogress = function(e) {
      if (e.lengthComputable && document.getElementById("play")) {
...
ChiptuneJsPlayer.prototype.createLibopenmptNode = function(buffer, config) {
  ...
  var stack = stackSave();
  libopenmpt._openmpt_module_ctl_set(processNode.modulePtr, asciiToStack('render.resampler.emulate_amiga'), asciiToStack('0'));
  stackRestore(stack);
