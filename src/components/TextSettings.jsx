...
import { BsType, BsTextLeft, BsTextCenter, BsTextRight } from 'react-icons/bs';
...
const TextSettings = () => {
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', gap: '8px' }}>
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', borderBottom: '1px solid #444', paddingBottom: '6px', marginBottom: '4px' }}>
        <span style={{ fontWeight: 'bold', fontSize: '11px', textTransform: 'uppercase', color: '#4CAF50', letterSpacing: '0.5px', display: 'flex', alignItems: 'center', gap: '8px' }}>
